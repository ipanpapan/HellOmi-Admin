...
class klasemenGroupController extends Controller
{
    ...
    {
        $id=0;
        $cabor = Cabor::orderBy('nama_cabor','asc')->where('id_cabor','1')->orwhere('id_cabor','2')->orwhere('id_cabor','3')->orwhere('id_cabor','4')->orwhere('id_cabor','7')->orwhere('id_cabor','8')->orwhere('id_cabor','10')->get();
