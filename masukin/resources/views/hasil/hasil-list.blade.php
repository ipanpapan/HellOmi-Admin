                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    @foreach($hasil as $row)
                      <tr>
                        ...
                        @if($row->id_cabor==11 || $row->id_cabor==15 || $row->id_cabor==16) ALL
                            @else
                              @if($row->fakultasB==true)<?=fakultasName($row->fakultasA)?> : {{$row->resultA}} <br> <?=fakultasName($row->fakultasB)?> : {{$row->resultB}} @endif
                        ...
                        <td> <?=str_replace("\\n", "<br>",$row->detail)?></td>
                        <td>
                          <a href="{{ url('cabor/hasil/edit',$row->id_pertandingan) }}" data-placement="top" data-toggle="tooltip" type="button" data-original-title="Edit" class="btn  btn-sm tooltips"><i class="fa fa-pencil"></i></a>
                          <a href="{{ url('cabor/hasil/delete',$row->id_pertandingan) }}" data-placement="top" data-toggle="tooltip" type="button" data-original-title="Delete" class="btn  btn-sm tooltips"><i class="fa fa-trash-o"></i></a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
